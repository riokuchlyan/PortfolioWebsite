...
export default function AboutMe() {
    ...
    return (
        ...
        <HomeButton/>
            ...
            <div className="flex flex-col gap-4 row-start-2 items-center text-center max-w-[60%]">
                <h1 className='mt-64'>ABOUT ME</h1>
                <p className="mb-8">Hello! My name is Rio Kuchlyan and I am a developer focusing on the technology and finance industries. I am a student at the University of North Carolina at Chapel Hill pursuing a double major in computer science and business. Feel free to contact me through any of my socials in this page!</p>
